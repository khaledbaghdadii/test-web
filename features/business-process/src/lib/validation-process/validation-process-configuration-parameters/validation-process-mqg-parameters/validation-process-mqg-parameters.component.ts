...
import { MqgFromNewBranchParametersComponent } from "./mqg-from-new-branch-parameters/mqg-from-new-branch-parameters.component";
...
@Component({
  selector: "mxevolve-validation-process-mqg-parameters",
  templateUrl: "validation-process-mqg-parameters.component.html",
  imports: [
...
export class ValidationProcessMqgParametersComponent
