...
import { ValidationProcessDqgParametersComponent } from "./validation-process-dqg-parameters.component";

describe("Validation process DQG parameters", () => {
  let component: ValidationProcessDqgParametersComponent;

  beforeEach(() => {
    component = new ValidationProcessDqgParametersComponent();
  ...
  describe("When use existing branch is preselected", () => {
    ...
    it("When the user selects using an existing branch it should announce that use existing branch is selected", fakeAsync(() => {
      component.createBranchFormControl.setValue("false");
