...
describe("MergeConfigurationDropdownComponent", () => {
  ...
  describe("ControlValueAccessor", () => {
    ...
    it("should set state provider selectedItem when dropdownComponent is undefined", () => {
      component.dropdownComponent = undefined;

      component.writeValue(MOCK_MERGE_CONFIG);

      expect(component["stateProvider"].selectedItem()).toBe(MOCK_MERGE_CONFIG);
    });

    it("should clear state provider selectedItem when writeValue is called with null", () => {
      component.dropdownComponent = undefined;
      component.writeValue(MOCK_MERGE_CONFIG);
