...
describe("TestManagementAnalyticsTrackerService", () => {
  ...
  it("should track clean scenario execution button click", () => {
    service.trackCleanScenarioExecution();
  ...
  ])("should track unlink button click for %s", (analysisObjectType) => {
    service.trackUnlinkAnalysisObject(analysisObjectType);
  ...
  it.each([
    ...
    AnalysisObjectType.FAILURE_REASON,
    AnalysisObjectType.INCIDENT,
  ])("should track link button click for %s", (analysisObjectType) => {
    service.trackLinkAnalysisObject(analysisObjectType);
  ...
  it.each([AnalysisObjectType.BINARY_IMPACT, AnalysisObjectType.INCIDENT])(
    "should track previously linked %s toggle",
    (analysisObjectType) => {
      service.trackPreviouslyLinkedAnalysisObjectToggle(analysisObjectType);
  ...
  it("tracks the edit upgrade impact button click", () => {
    service.trackEditUpgradeImpact();
  ...
  it("tracks the submit upgrade impact button click", () => {
    service.trackSubmitSelectedUpgradeImpact();
